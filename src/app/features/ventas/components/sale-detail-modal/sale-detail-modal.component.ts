                  ...
                  @for (item of detallesEnriquecidos(); track $index) {
                    <div class="flex gap-4 pb-3 border-b border-gray-100">
                      @if (item.fotoUrl) {
                        ...
                        <div
                          class="w-16 h-20 bg-gray-200 flex-shrink-0 flex items-center justify-center"
                        >
                          <svg
                      ...
                      <div class="flex-1 min-w-0">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-2 mt-2 text-xs">
                          <span class="text-gray-600"
                            >Costo Unit.: {{ formatOptionalMoney(item.costo_unitario) }}</span
                          >
                          <span class="text-gray-600"
                            >Ganancia Unit.: {{ formatOptionalMoney(item.ganancia_unitaria) }}</span
                          >
                          <span class="text-gray-900 font-semibold"
                            >Ganancia Total: {{ formatOptionalMoney(item.ganancia_total) }}</span
                          >
                        </div>
                      </div>
                    </div>
...
export class SaleDetailModalComponent {
  ...
  formatOptionalMoney(value?: number): string {
