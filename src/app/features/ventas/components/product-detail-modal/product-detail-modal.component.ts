              ...
              <div class="space-y-2 md:space-y-3">
                ...
                <div class="flex items-center gap-2 border-b border-gray-300 pb-2">
                  ...
                  <input
                    ...
                    min="0"
                    step="0.01"
                    class="w-full text-xl md:text-3xl font-semibold text-gray-900 outline-none bg-white border-b-2 border-transparent focus:border-primary transition-colors"
                    [ngModel]="priceInput()"
