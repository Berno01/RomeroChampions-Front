        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div class="flex flex-wrap items-center gap-3 md:gap-8">
            ...
            <div class="relative group">
              <button
                class="flex items-center gap-2 text-xs md:text-sm font-medium text-gray-700 hover:text-primary transition-colors uppercase tracking-wider"
          ...
          <div class="flex flex-col md:items-end gap-3 w-full md:w-auto">
            <!-- Buscador -->
            <div
              class="flex items-center gap-2 w-full md:w-80 border-b border-gray-300 focus-within:border-primary transition-colors pb-1"
            >
              <svg
            ...
            <button
              type="button"
              class="w-full md:w-auto px-4 md:px-6 py-2.5 bg-primary text-white text-xs font-bold tracking-[0.15em] md:tracking-[0.2em] hover:opacity-90 transition-colors flex items-center justify-center gap-2"
              (click)="onNewModelo()"
            >
              <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path
