        ...
        <div class="hidden md:flex items-center gap-2">
          ...
          <div class="relative group">
            ...
            >
              ...
              <span>RESUMEN</span>
              <svg
                class="w-3 h-3 text-gray-400 group-hover:text-gray-600 ml-0.5"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            <!-- Dropdown Menu -->
            <div
              class="absolute left-0 top-full pt-1 w-52 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 transform origin-top-left z-50"
            >
              <div
                class="bg-white rounded-lg shadow-xl border border-gray-100 overflow-hidden py-1"
              >
                <a
                  routerLink="/dashboard"
                  class="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 hover:text-black"
                >
                  <svg
          ...
          <div class="relative group">
            ...
            >
              ...
              >
                <a
                  routerLink="/ventas"
                  routerLinkActive="bg-gray-50 text-black font-semibold"
